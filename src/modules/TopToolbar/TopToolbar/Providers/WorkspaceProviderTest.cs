            ...
            try
            {
                ...
                if (updatedProfile != null)
                {
                    ...
                    if (workspacesGroup?.Actions != null)
                    {
                        ...
                        {
                            Console.WriteLine("✓ Success: New workspace was automatically added to profile and enabled");
                        }
                        else
                        {
                            Console.WriteLine("✗ Failed: New workspace was not properly added to profile");
                        }
                    }
                    else
                    {
                        Console.WriteLine("✗ Failed: Workspaces group not found in profile");
                    }
                }
                else
                {
                    Console.WriteLine("✗ Failed: Could not retrieve updated profile");
                }
